...
PRED_CSV = ANALYSIS_DIR / "rf_rsbest_block2p0_cv_predictions.csv"
OUT_DIR = ANALYSIS_DIR / "rf_rsbest_block2p0_diagnostics"
...
def main():
    ...
    fig1 = px.scatter(
        ...
        y="predicted",
        opacity=0.25,
        title="Observed vs Predicted (RF-rsbest, 2.0 spatial CV)"
    )
    ...
    fig2 = px.scatter(
        ...
        y="residual",
        opacity=0.25,
        title="Residuals vs Observed (RF-rsbest, 2.0 spatial CV)"
    )
    ...
    fig3 = px.histogram(
        ...
        x="residual",
        nbins=50,
        title="Residual Distribution (RF-rsbest, 2.0 spatial CV)"
    )
